                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							<li><a href="index.php"><span>Mandiri Filter</span></a></li>
							<li><a href="logout.php"><span>Kembali ke Toko</span></a></li>
							<li>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form action="produk.php" method="post" enctype="multipart/form-data" >
								...
								<div class="form-group">
									<input name="hargaafter" type="hidden" class="form-control" value="0">
								</div>
								<div class="form-group">
									<label>Gambar</label>
